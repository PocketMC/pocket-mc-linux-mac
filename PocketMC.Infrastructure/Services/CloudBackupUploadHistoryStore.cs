...
namespace PocketMC.Infrastructure.Services
{
    ...
    public class CloudBackupUploadHistoryStore
    {
        ...
        public CloudBackupUploadHistoryStore(ISettingsService settingsService, ILogger<CloudBackupUploadHistoryStore> logger)
        {
            _logger = logger;
            _historyFilePath = Path.Combine(settingsService.GetSettingsDirectory(), "cloud-backup-history.json");
        }
