...
namespace PocketMC.Infrastructure.Services
{
    public class DropboxBackupProvider : ICloudBackupProvider
    {
        ...
        public DropboxBackupProvider(ISettingsService settingsService, ILogger<DropboxBackupProvider> logger)
        {
        ...
        public async Task ConnectAsync(CancellationToken ct)
        {
            ...
            PocketMC.Infrastructure.Services.Providers.OAuth.BrowserHelper.OpenUrl(uri);
